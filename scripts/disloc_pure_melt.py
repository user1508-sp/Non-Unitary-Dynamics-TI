...
def run_simulation(params):
    ...
    # positive eignevalue dislocation mode
    ...
    eigval_below_zero = sorted_eigvals[negative_index]
    eigvec_below_zero = sorted_eigvecs[:, negative_index]

    eigval_above_zero = sorted_eigvals[positive_index]
    eigvec_above_zero = sorted_eigvecs[:, positive_index]

    v0 = eigvec_above_zero
